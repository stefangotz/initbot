...
FROM ghcr.io/astral-sh/uv:python3.14-alpine@sha256:ab7739a904d2bd04d66a9ec21cb26e045f8854de80e546b8a6ae5648b9bf8e60 AS builder
COPY . /root/
WORKDIR /root
...
FROM ghcr.io/astral-sh/uv:python3.14-alpine@sha256:ab7739a904d2bd04d66a9ec21cb26e045f8854de80e546b8a6ae5648b9bf8e60 AS runtime-base
